...
SEN_TEMPL ="""<sensor>
    ...
    <exclude_from_parse>1</exclude_from_parse>
    <delimiter>|</delimiter>
    <description>Use Osquery</description>
    <what_hash></what_hash>
    <hidden_flag>0</hidden_flag>
    <columns>
      %s
...
for line in sys.stdin:
   ...
   sen_nam   = "Osquery " + table_nam.replace("_"," ").title()
   ...
   tmp_qry_dwn = QRY_TEMPL_DWN%(table_nam)
   tmp_sen     = SEN_TEMPL%(sen_nam,tmp_cols,tmp_qry,tmp_qry_dwn)
